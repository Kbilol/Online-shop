  ...
  resolve: {
    alias: {
      ...
      "@product": fileURLToPath(
        new URL("./src/modules/product", import.meta.url),
      ),
      "@category": fileURLToPath(
        new URL("./src/modules/category", import.meta.url),
      ),
      "@user": fileURLToPath(new URL("./src/modules/user", import.meta.url)),
      "@theme": fileURLToPath(new URL("./src/modules/theme", import.meta.url)),
    },
  },
});
